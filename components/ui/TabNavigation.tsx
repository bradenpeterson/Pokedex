  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
        <div className="flex items-end space-x-2 sm:space-x-2 md:space-x-4 min-h-[96px] sm:min-h-[64px] py-3 sm:py-2">
          {/* Home Button - Just the Logo */}
          <Link
            href="/pokemon"
            className="flex items-end justify-center pb-1 hover:opacity-80 transition-opacity duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded self-end mr-2 sm:mr-3 md:mr-6 lg:mr-8 flex-shrink-0"
            aria-label="Home - Pokemon List"
          >
            <div className="relative w-[120px] h-14 sm:w-32 sm:h-14 md:w-40 md:h-18 lg:w-52 lg:h-24 flex-shrink-0">
              <Image
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={`
                  whitespace-nowrap py-2.5 px-2.5 sm:py-2 sm:px-2 md:py-3 md:px-4 border-b-[6px] sm:border-b-4 font-bold text-[15px] sm:text-xs md:text-sm
                  ...
                  min-w-[54px] min-h-[54px] sm:min-w-[44px] sm:min-h-[44px] flex items-center justify-center
